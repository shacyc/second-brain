...
export function LoginForm({
  ...
  return (
    (<div className={cn("flex flex-col gap-6", className)} {...props}>
      ...
      <div
        className="text-balance text-center text-xs text-zinc-500 [&_a]:underline [&_a]:underline-offset-4 [&_a]:hover:text-zinc-900  dark:text-zinc-400 dark:[&_a]:hover:text-zinc-50">
